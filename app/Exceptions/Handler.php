...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
        ...
        if ($exception instanceof ModelNotFoundException) {
            ...
            return $this->errorResponse("{$modelName} with the specified identicator does not exist.", 404);
        }
        ...
        if ($exception instanceof QueryException) {
            ...
            if ($errorCode == 1451) {
                return $this
                    ->errorResponse(
                        'Cannot remove this resource permanently, It us currently related with other resource.',
                        409
                    );
            }
        }
